...
//var owner            = null;
  ...
  //fC = new FunctionCompute();
  //fD = new FunctionCompute();
    fD = new FunctionCompute();
    fD = new FunctionComputeDerivate();
    fC.compute_expr(fC.get_sExprX("2+cos(t)*4","t"));
  //fC.compute_expr("2+cos(x)*4");
  //fC.infixPostfix("2+cos(x)*4");
    var a = fC.get_postfixArray(); alert(a);
    var b = fC.compute_value();    alert(b);
  ...
  function init_obj()      { 
    ...
    txt_input     = new Txt  (layerObj,  1,100,200, 20,"",true);
  ...
  //txt_output    = makeTxtLb(layerObj,  1,130,200, 20,"",true);
    ...
    sb_scroll     = new Sb   (layerObj, 10,410,200, 0,1000,1,0);
  ...
  //txt_input.get_obj() .onchange    = function() { act_txtInput      ();}
    txt_input .onkeyup     = function() { act_txtInput      ();}
  //sb_scroll .addEventListener("mousemove",  act_sbEMove); 
    sb_scroll.get_obj()  .onmousedown = function() { act_sbEDown       ();}  
    sb_scroll.get_obj() .onmousemove = function() { act_sbEMove       ();}  
  //sb_scroll .onchange    = function() { act_sbEMove       ();}
    sb_scroll.get_obj()  .onmouseout  = function() { act_sbEOut        ();}
