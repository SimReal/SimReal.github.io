...
function Car_Position() {
  ...
  var txt_position     = null;                               //            position
  ...
  function init_listener()    {
   txt_position .onkeyup = function() { act_txtPosition ();}
    cb_show     .onclick = function() { act_cbShow      ();}
  } 
  /*----------------------------------------------------------------------------------------------- action ---*/

  function act_txtPosition() {
    fC.compute_expr(fC.get_sExprX(txt_position.value,"t"));  
  }
  function act_cbShow() {
  ...
  function movePos(t)         {
    car.moveTo(x0+fC.compute_value(t));                      // move the car
  }
  /*----------------------------------------------------------------------------------------------------------*/
}
/*============================================================================================================*/
